# Adipositas · Rechercheportal

Ein Rechercheportal zum Themenfeld **Adipositas**: 64 Datenbanken in 10 Rubriken,
davon 31 mit Live-Suche, dazu eine täglich aus PubMed kuratierte Studienauswahl mit
...
Secrets im Repository: `ADIPOSITASHUB` (Claude-API) und `ADIPOSITASHUBMC` (Mailchimp).
